...
import 'presentation/screen/historico/atendimento_form_screen.dart';
import 'presentation/screen/historico/historico_screen.dart';
...
import 'presentation/screen/plano/plano_detail_screen.dart';
...
import 'presentation/screen/servico/servico_form_screen.dart';
import 'presentation/screen/servico/servico_list_screen.dart';
...
class AppRoutes {
  ...
  static const String planoDetalhe = '/planos/detalhe';
  ...
  static const String atendimentoForm = '/historico/form';
  ...
  static final Map<String, WidgetBuilder> routes = {
    ...
    planoDetalhe: (_) => const PlanoDetailScreen(),
    ...
    servicoForm: (_) => const ServicoFormScreen(),
    historico: (_) => const HistoricoScreen(),
    atendimentoForm: (_) => const AtendimentoFormScreen(),
